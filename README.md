...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f1bbf57b-ad73-434f-aa02-251f91ff6f6b
```

> `f1bbf57b-ad73-434f-aa02-251f91ff6f6b` is the password of the certificate, you can change it to any password you want.
